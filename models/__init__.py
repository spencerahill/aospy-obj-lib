"""models.py: Collection of Spencer Hill's aospy.Model objects."""
from aospy.model import Model
from aospy.utils import _load_user_data

runs = _load_user_data('runs')
...
am2p5 = Model(
    ...
    nc_grid_paths=(
        ...
        ['/archive/miz/hiramdp/siena_201204/c180l32_am2_C0/gfdl.ncrc2-intel-'
        'prod/pp/atmos/ts/monthly/10yr/atmos.%04d01-%04d12.ucomp.nc' % (y1, y2)
         for (y1, y2) in zip((1981, 1991), (1990, 2000))]
    ),
    nc_dur=10,
    nc_start_yr=1981,
    nc_end_yr=2000,
