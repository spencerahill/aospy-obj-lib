...
energy_horiz_advec_eta_upwind_thermo = Var(
    name='energy_horiz_advec_eta_upwind_thermo',
    domain='atmos',
    description='Hack to avoid over-long filenames w/ data from mult. runs',
    variables=(temp, hght, sphum, ice_wat, ucomp, vcomp, ps, bk, pk),
    def_time=True,
    def_vert=True,
    def_lat=True,
...
energy_horiz_advec_eta_upwind_dyn = Var(
    name='energy_horiz_advec_eta_upwind_dyn',
    domain='atmos',
    description='Hack to avoid over-long filenames w/ data from mult. runs',
    variables=(temp, hght, sphum, ice_wat, ucomp, vcomp, ps, bk, pk),
    def_time=True,
...
energy_horiz_advec_eta_upwind_covar = Var(
    name='energy_horiz_advec_eta_upwind_covar',
    domain='atmos',
    description='Hack to avoid over-long filenames w/ data from mult. runs',
    variables=(temp, hght, sphum, ice_wat, ucomp, vcomp, ps, bk, pk),
    def_time=True,
...
energy_horiz_advec_eta_upwind_time_mean = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_horiz_advec_eta_upwind_time_mean,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
energy_horiz_divg_eta = Var(
    name='energy_horiz_divg_eta',
    domain='atmos',
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_horiz_divg_eta,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
energy_column_vert_advec_as_resid_eta_time_mean = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_column_vert_advec_as_resid_eta_time_mean,
    units=units.W_m2,
    colormap='RdBu'
)
...
energy_vert_advec_eta = Var(
    name='energy_vert_advec_eta',
    domain='atmos',
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_vert_advec_eta,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
energy_vert_advec_eta_adj = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_vert_advec_eta_adj,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
...
energy_vert_advec_eta_upwind = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_vert_advec_eta_upwind,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
energy_vert_advec_eta_upwind_thermo = Var(
    name='energy_vert_advec_eta_upwind_thermo',
    domain='atmos',
    description='Hack to avoid over-long filenames w/ data from mult. runs',
    variables=(temp, hght, sphum, ice_wat, ucomp, vcomp, omega, ps, bk, pk),
    def_time=True,
...
energy_vert_advec_eta_upwind_dyn = Var(
    name='energy_vert_advec_eta_upwind_dyn',
    domain='atmos',
    description='Hack to avoid over-long filenames w/ data from mult. runs',
    variables=(temp, hght, sphum, ice_wat, ucomp, vcomp, omega, ps, bk, pk),
    def_time=True,
...
energy_vert_advec_eta_upwind_covar = Var(
    name='energy_vert_advec_eta_upwind_covar',
    domain='atmos',
    description='Hack to avoid over-long filenames w/ data from mult. runs',
    variables=(temp, hght, sphum, ice_wat, ucomp, vcomp, omega, ps, bk, pk),
    def_time=True,
...
energy_vert_advec_eta_time_mean = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_vert_advec_eta_time_mean,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
energy_vert_advec_eta_adj_time_mean = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_vert_advec_eta_adj_time_mean,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
...
energy_vert_advec_eta_upwind_adj_time_mean = Var(
    ...
    def_lat=True,
    def_lon=True,
    func=calcs.energy_vert_advec_eta_upwind_adj_time_mean,
    units=units.J_kg1_s1,
    colormap='RdBu'
)
mass_column = Var(
...
moist_static_stab = Var(
    ...
    domain='atmos',
    variables=(temp, hght, sphum, ps, bk, pk),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
...
frozen_moist_static_stab = Var(
    name='frozen_moist_static_stab',
    domain='atmos',
    variables=(temp, hght, sphum, ice_wat, ps, bk, pk),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
    func=calcs.frozen_moist_static_stab,
    units=units.J_kg1_Pa1,
)
...
frozen_moist_static_stab_p = Var(
    name='frozen_moist_static_stab_p',
    domain='atmos',
    variables=(temp, hght, sphum, ice_wat),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
    func=calcs.frozen_moist_static_stab_p,
    units=units.J_kg1_Pa1,
)
mse = Var(
    name='mse',
...
mse_from_hypso = Var(
    ...
    domain='atmos',
    math_str=r'$h$',
    variables=(ps, temp, sphum),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
    func=calcs.mse_from_hypso,
    units=units.J_kg1,
)
z_from_hypso = Var(
    name='z_from_hypso',
