#! /usr/bin/env python
"""Main testing module for `aospy_user` package."""
import sys
import unittest
...
class CalcsTestCase(unittest.TestCase):
    def setUp(self):
        self._array_len = 10
...
class TestCalcs(CalcsTestCase):
    ...
    def test_fwd_diff1_zero_slope(self):
        np.testing.assert_array_equal(calcs.fwd_diff1(self.ones, self.arange),
                                      self.zeros_trunc1)
        np.testing.assert_array_equal(calcs.fwd_diff1(self.zeros, self.arange),
                                      self.zeros_trunc1)
    ...
    def test_fwd_diff2_zero_slope(self):
        np.testing.assert_array_equal(calcs.fwd_diff2(self.ones, self.arange),
                                      self.zeros_trunc2)
        np.testing.assert_array_equal(calcs.fwd_diff2(self.zeros, self.arange),
                                      self.zeros_trunc2)
    ...
    def test_cen_diff2_zero_slope(self):
        np.testing.assert_array_equal(calcs.cen_diff2(self.ones, self.arange),
                                      self.zeros_trunc2)
        np.testing.assert_array_equal(calcs.cen_diff2(self.zeros, self.arange),
                                      self.zeros_trunc2)
    ...
    def test_cen_diff4_zero_slope(self):
        np.testing.assert_array_equal(calcs.cen_diff4(self.ones, self.arange),
                                      self.zeros_trunc4)
        np.testing.assert_array_equal(calcs.cen_diff4(self.zeros, self.arange),
                                      self.zeros_trunc4)
