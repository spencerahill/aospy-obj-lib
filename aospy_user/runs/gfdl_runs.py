...
am3_aero = Run(
    ...
    data_in_direc='/archive/Yi.Ming/fms/siena_201211/c48L48_am3p10_aero/gfdl.ncrc2-intel-prod/pp'
)
am3_atm = Run(
    name='aero_tm',
    description='1981-2000 HadISST climatological annual cycle of SSTs and sea ice repeated annually, overlaid with annual tropical mean equilibrium SST anomaly from a PI-to-PD aerosols simulation of AM2.1 with a mixed layer ocean. PD atmospheric composition.',
    data_in_direc='/archive/Yi.Ming/fms/siena_201211/c48L48_am3p10_aero_trop_mean/gfdl.ncrc2-intel-prod/pp'
)
am3_amtm = Run(
    name='aero_mtm',
    description='1981-2000 HadISST climatological annual cycle of SSTs and sea ice repeated annually, subtracting annual tropical mean equilibrium SST anomaly from a PI-to-PD aerosols simulation of AM2.1 with a mixed layer ocean. PD atmospheric composition.',
...
am3_hc_static_veg_10kyr = Run(
    ...
    data_in_direc=('/archive/Spencer.Hill/am3/am3clim_hurrell_static_veg_10kyr_obliq_prec/'
              'gfdl.ncrc2-intel-prod-openmp/pp'),
    data_in_dur=30,
    data_in_start_date=1981,
    data_in_end_date=2010,
...
hiram_atm = Run(
    ...
    default_date_range=(1979, 1995),
    data_in_direc=('/archive/Yi.Ming/siena_201211/c180_hiram_clim_aero_trop_mean/'
              'gfdl.ncrc2-default-prod/pp')
)
hiram_amtm = Run(
    name='aero_mtm',
    ...
    default_date_range=(1979, 1995),
    data_in_direc=('/archive/Yi.Ming/siena_201211/c180_hiram_clim_aero_m_trop_mean/'
              'gfdl.ncrc2-default-prod/pp')
)
hiram_apac = Run(
    name='aero_pac',
...
hiram_gtm = Run(
    ...
    default_date_range=(1979, 1995),
    data_in_direc=('/archive/Yi.Ming/siena_201211/c180_hiram_clim_gas_trop_mean/'
              'gfdl.ncrc2-default-prod/pp')
)
hiram_gmtm = Run(
    name='gas_mtm',
    ...
    default_date_range=(1979, 1995),
    data_in_direc=('/archive/Yi.Ming/siena_201211/c180_hiram_clim_gas_m_trop_mean'
              '/gfdl.ncrc2-default-prod/pp')
)
hiram_amip = Run(
    name='amip',
...
hiram_c48_1_p2K = Run(
    name='ming1_p2K',
    description='',
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X0b_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_2 = Run(
    name='ming2',
...
hiram_c48_2_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X0e_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_3 = Run(
    name='ming3',
...
hiram_c48_3_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X0f_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_4 = Run(
    name='ming4',
...
hiram_c48_4_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X0c_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_5 = Run(
    name='ming5',
...
hiram_c48_5_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X01_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_6 = Run(
    name='ming6',
...
hiram_c48_6_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X02_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_7 = Run(
    name='ming7',
...
hiram_c48_7_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X03_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
hiram_c48_8 = Run(
    name='ming8',
...
hiram_c48_8_p2K = Run(
    ...
    description='',
    default_date_range=(1981, 1995),
    data_in_direc='/archive/Ming.Zhao/hiramdp/siena_201204/c48l32_him_X04_p2K/'+\
             'gfdl.ncrc2-intel-prod/pp'
)
...
am2p5_p2K = Run(
    name='p2K',
    description='',
    data_in_direc='/archive/miz/hiramdp/siena_201204/c180l32_am2_C0_p2K/gfdl.ncrc2-intel-prod/pp'
)
